...
import StructureHTMLDocument from '../../HTMLCourses/1/StructureHTMLDocument/StructureHTMLDocument';
...
const BasicHTML = props => {
  ...
  return (
    <Container>
      <Route exact path={url} render={props => <MenuHTML {...props} />} />

      <Switch>
        <Route path={`${url}/1/run/1`} component={StructureHTMLDocument} />
